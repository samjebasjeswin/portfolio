...
export default function NewNavbar({ onContactClick }: { onContactClick?: () => void }) {
    ...
    return (
        ...
        >
            <div className="glass-dark rounded-[2rem] px-8 py-4 flex justify-between items-center border border-white/10 shadow-[0_20px_50px_rgba(0,0,0,0.5)]">
                ...
                <div className="hidden md:flex gap-8">
                    {navItems.map((item) => (
                        <Link
                            ...
                            className="text-xs font-mono uppercase tracking-widest text-zinc-500 hover:text-white transition-all relative group"
                        >
                            {item}
